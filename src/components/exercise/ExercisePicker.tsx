...
const BADGE_STYLES: Record<string, string> = {
  sore: 'bg-amber-900/30 text-amber-400 border-amber-700',
  good: 'bg-green-900/30 text-green-400 border-green-700',
  recovery: 'bg-blue-900/30 text-blue-400 border-blue-700',
};
